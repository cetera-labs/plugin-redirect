...
$r = $application->getConn()->executeQuery('SELECT id, ro_www, ro_ss, ro_ms, ro_remin, ro_404, ro_cetera, ro_pc FROM r_options_plugin ORDER BY ' . $_REQUEST['sort'] . ' ' . $_REQUEST['dir']);
